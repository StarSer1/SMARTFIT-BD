    ...
    public partial class FormPrincipal : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string cadenaConexion = @"Data Source=BRANDONWROK\SQLEXPRESS;Initial Catalog=master;Integrated Security=True;";
        ...
        private void btnCrearDB_Click(object sender, EventArgs e)
        {
            try
            {
                //@"Data Source=DESKTOP-0434B1E;Initial Catalog=master;Integrated Security=True;"
                string cadenaConexion = @"Data Source=BRANDONWROK\SQLEXPRESS;Initial Catalog=master;Integrated Security=True;";
                string cadenaConexion2 = @"Data Source=BRANDONWROK\SQLEXPRESS;Initial Catalog=SMARTFITBD;Integrated Security=True;";
